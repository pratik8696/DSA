...
void build(v64 &arr, v64 &tree, ll s, ll e, ll tn)
{
    if (s == e)
    {
        tree[tn] = arr[s];
...
ll query(v64 &arr, v64 &tree, ll s, ll e, ll tn, ll l, ll r)
{
    ll mid = (s + e) / 2;
    // out
    if (s > r || l > e)
...
void update(v64 &arr, v64 &tree, ll s, ll e, ll tn, ll idx, ll val)
{
    if (s == e)
    {
        arr[idx] = val;
