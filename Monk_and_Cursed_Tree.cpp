...
void solve()
{
    ...
    {
        cin >> values[i + 1];
        root = insertIntoBST(root, values[i + 1]);
    }
    ll x, y;
    cin >> x >> y;
    dbg(maxInPath(root, x, y));
}
