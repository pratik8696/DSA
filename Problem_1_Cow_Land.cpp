...
public:
    ...
    ll lca_sum_query(ll a, ll b)
    {
        ...
        while (head[a] != head[b])
        {
            ...
            // cout << query(0, idx - 1, 1, pos[head[a]], pos[a]);
            a = parent[head[a]];
        }
        // cout << a << " " << b << endl;
        ...
        // cout << query(0, idx - 1, 1, pos[b], pos[a]) << endl;
        return sum;
    }
...
void solve()
{
    ...
    while (q--)
    {
        ...
        else
        {
            ...
            cout << hld.lca_sum_query(a, b) << endl;
            // cout << hld.lca_sum_query(1, 1) << " " << hld.lca_sum_query(3, 3) << " " << hld.lca_sum_query(5, 5) << " " << hld.lca_sum_query(1, 5) << endl;
        }
    }
    // cout << 3 << endl;
}
